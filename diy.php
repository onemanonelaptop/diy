...
function diy_init() {
    ...
    if (!class_exists('Diy')) {
            ...
            */
            class Diy {
                    ...
                    // Store the defined post meta boxes e.g. $meta[post-type][metabox-id][field-id][group-instance][group-index]
                    protected $meta = array();

                    /**
                    * @var string The Title that is displayed on the options page
                    */
                    var $settings_page_title = "Options Page";

                    /**
                    * @var string The menu anchor link text for the options page
                    */
                    var $settings_page_link = "Options";
                    ...
                    */
                    ...
                    public function start() {
                        ...
                        // If we havent got a user defined slug then exit
                            ...
                            // Add the plugins options page	unless the diy is being used just for metaboxes		
                            if ($this->usage != 'meta') {
			...
			return $hook;
                    ...
                    function diy_fields() {
                        ...
                        foreach($this->fields as $field) {
                            ...
                            if ($metabox_post_types!="") {
                                ...
                                register_setting( $this->options_group, $field['group'], array(&$this,'validate_setting'));
                    ...
                    function validate_setting($data) {
                         return $this->suggest_to_id($data);;
                    }
                    ...
                    /**
                    * Vogon constructor method runs on object creation
                    *
                    * @since	0.1
                    * @param 	$file 	Contains __FILE__ for the file extending this class
                    * @access	public
                    */
            ...
            *
            * @since	0.1
            * @param	string 	$p 	The text to use for the suffix
            * @access	public
            */
            function suffix($p) {
                    return ( (!empty($p)) ? '<span class="field-suffix">' . $p . '</span>' : '');
            } // function
            ...
            */ 
            ...
            function diy_save_post( $post_id ) {
                    ...
                    if (isset($_POST['post_type'])  && $_POST['post_type'] && $this->meta[$_POST['post_type']]  ) {
                            // print var_export($this->meta[$_POST['post_type']],true);
                            ...
                            foreach ($this->meta[$_POST['post_type']] as $section_name => $section) {
                                   ...
                                   // print "Section Name: " . $section_name . "<br>";
                                    foreach($section as $group_name => $group) {
                                    	//print "Group Name: " . $group_name . "<br>";

                                            $data = $_POST[$group['group']];

                                   // print var_export($data,true) . "<br>" . $group['group'];
            ...
            function diy_option_field_builder($data,$args) {
                    // Print some additional information at the top of the metabox
            ...
            /**
            * Print the CSS into the admin header
            *
            * The CSS is included inline instead of a separate file to keep the diy as a single file
            * 
            * @hook	admin_head
            * @since	0.1
            * @access	public
            */ 	
            function diy_css() {
                    ...
                    *
                    * The JS is included inline instead of a separate file to keep the diy as a single file
                    * 
                    * @hook		admin_foot
                    * @since	0.1
                    * @access	public
    ...
    // Run each of the depandant plugins own init methods
    do_action( 'diy_init' );
}
